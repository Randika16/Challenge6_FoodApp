...
import com.example.challenge2_foodapp.core.data.source.local.datasource.FoodDataSource
import com.example.challenge2_foodapp.core.data.source.local.datasource.FoodDatabaseDataSource
...
object DataSourceModule {
    ...
    fun provideFoodDataSource(foodDao: FoodDao): FoodDataSource {
        return FoodDatabaseDataSource(foodDao)
    }
